...
: void
{
    ...
    .then( data => {
        ...
        let entriesHtmlTableElement : HTMLElement | null = document.getElementById(entriesHtmlTableDivId);
...
.addEventListener(
    "click",
    () => renderEntriesTable("http://localhost:8080/api/user/all","usersTableDiv")
);
