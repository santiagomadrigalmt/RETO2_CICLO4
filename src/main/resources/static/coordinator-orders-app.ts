...
// ### IMPORTS ###
// ###############
import { User, Order, Clone } from "./functions.js";
...
: void
{
    ...
    .then( 
        ...
        let currentMoreInfoButton : HTMLButtonElement,
        currentApproveOrderButton : HTMLButtonElement,
        currentRejectOrderButton : HTMLButtonElement;
        ...
        for (let i = 0; i < ordersList.length; i++)
        {
            ...
            // Status:
            currentCell = document.createElement("td");
            if ( ordersList[i]["status"] === "Aprobada" ) currentCell.setAttribute("style","color:yellow");
            else if ( ordersList[i]["status"] === "Rechazada" ) currentCell.setAttribute("style","color:red");
...
window.onload = function() : void
{
    ...
    else
    {
        ...
        else
        {
            ...
            document.getElementById("ordersTable")!.addEventListener
            (
                "click",
                function(event)
                {
                    ...
                    {
                        let currentOrder : Order = globalOrdersList[ parseInt(currentButton.getAttribute("orderIndex")) ];
                        ...
                        let modalBody : HTMLElement = document.getElementById("orderMoreInfoModalBody")!;
                        modalBody.innerHTML = "";
                        let productsObject : Object = currentOrder["products"];
                        ...
                        for( let currentProductObject of Object.values(productsObject) )
                        {
                            ...
                            let currentProductInfoTable : HTMLElement = document.createElement("table");
                            currentProductInfoTable.setAttribute("width","100%");
            
                            let currentRow : HTMLElement, 
                            currentCellAttributeName : HTMLElement,
                            currentCellAttributeValue : HTMLElement;
                            ...
                            for (let currentProp in propsToSpanishNames )
                            {
                                ...
                                {
                                    if ( currentProductObject["availability"] ) currentCellAttributeValue.innerHTML = "SÍ";
                                    else currentCellAttributeValue.innerHTML = "NO";
                                }
                                else
                                {
